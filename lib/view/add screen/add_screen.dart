        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Write and share your own quotes. These will only visible to you.' ,style: Theme.of(context).textTheme.titleMedium!.copyWith(fontSize: 18 , color: Colors.grey), ),
            ),
           Padding(
